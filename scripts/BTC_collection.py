...
def crypto_data(symbol='BTC/USDT', timeframe='1d', start_date="2017-08-01T00:00:00Z"):
...
if __name__ == "__main__":
    ...
    df = crypto_data('BTC/USDT', '1d', start_date="2017-08-01T00:00:00Z")
    
    # Save to CSV
    df.to_csv('data/BTC_USDT_binance.csv')
